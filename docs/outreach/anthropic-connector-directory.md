...
|---|---|---|
| Privacy policy URL, HTTPS, covering collection, usage/storage, third-party sharing, retention, contact. "Missing or incomplete privacy policies result in immediate rejection." | ✗ https://www.gemina.co/privacy returned **404** | Ship the website branch page, re-curl for 200. |
...
4. **Listing**
   - Name (≤100): `Gemina`
   - Tagline (≤55): `Invoice OCR, document extraction, search and tagging` (52)
   ...
   - Privacy policy URL: `https://www.gemina.co/privacy`
