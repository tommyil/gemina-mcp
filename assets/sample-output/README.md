...
- Document the variation across document types.

The included `invoice.example.json` shows the canonical response for a vendor invoice. Add more as new sample inputs are contributed.
